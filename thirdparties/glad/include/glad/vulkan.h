/**
 * Loader generated by glad 2.0.4 on Sun Dec 31 23:54:06 2023
 *
...
GLAD_API_CALL int GLAD_VK_ARM_scheduling_controls;
...
GLAD_API_CALL int GLAD_VK_EXT_nested_command_buffer;
...
GLAD_API_CALL int GLAD_VK_IMG_relaxed_line_rasterization;
...
GLAD_API_CALL int GLAD_VK_KHR_video_maintenance1;
...
GLAD_API_CALL int GLAD_VK_NV_cuda_kernel_launch;
...
GLAD_API_CALL int GLAD_VK_NV_extended_sparse_address_space;
...
GLAD_API_CALL int GLAD_VK_NV_per_stage_descriptor_set;
...
typedef void (GLAD_API_PTR *PFN_vkCmdBindDescriptorSets2KHR)(VkCommandBuffer commandBuffer, const VkBindDescriptorSetsInfoKHR * pBindDescriptorSetsInfo);
...
typedef void (GLAD_API_PTR *PFN_vkCmdPushConstants2KHR)(VkCommandBuffer commandBuffer, const VkPushConstantsInfoKHR * pPushConstantsInfo);
typedef void (GLAD_API_PTR *PFN_vkCmdPushDescriptorSet2KHR)(VkCommandBuffer commandBuffer, const VkPushDescriptorSetInfoKHR * pPushDescriptorSetInfo);
...
typedef void (GLAD_API_PTR *PFN_vkCmdPushDescriptorSetWithTemplate2KHR)(VkCommandBuffer commandBuffer, const VkPushDescriptorSetWithTemplateInfoKHR * pPushDescriptorSetWithTemplateInfo);
...
GLAD_API_CALL PFN_vkCmdCudaLaunchKernelNV glad_vkCmdCudaLaunchKernelNV;
#define vkCmdCudaLaunchKernelNV glad_vkCmdCudaLaunchKernelNV
...
GLAD_API_CALL PFN_vkCreateCudaFunctionNV glad_vkCreateCudaFunctionNV;
#define vkCreateCudaFunctionNV glad_vkCreateCudaFunctionNV
GLAD_API_CALL PFN_vkCreateCudaModuleNV glad_vkCreateCudaModuleNV;
#define vkCreateCudaModuleNV glad_vkCreateCudaModuleNV
...
GLAD_API_CALL PFN_vkDestroyCudaFunctionNV glad_vkDestroyCudaFunctionNV;
#define vkDestroyCudaFunctionNV glad_vkDestroyCudaFunctionNV
GLAD_API_CALL PFN_vkDestroyCudaModuleNV glad_vkDestroyCudaModuleNV;
#define vkDestroyCudaModuleNV glad_vkDestroyCudaModuleNV
...
GLAD_API_CALL PFN_vkGetCudaModuleCacheNV glad_vkGetCudaModuleCacheNV;
#define vkGetCudaModuleCacheNV glad_vkGetCudaModuleCacheNV
...
#define vkGetLatencyTimingsNV glad_vkGetLatencyTimingsNV
#if defined(VK_USE_PLATFORM_ANDROID_KHR)
...
#define vkLatencySleepNV glad_vkLatencySleepNV
...
#define vkSetLatencyMarkerNV glad_vkSetLatencyMarkerNV
GLAD_API_CALL PFN_vkSetLatencySleepModeNV glad_vkSetLatencySleepModeNV;
#define vkSetLatencySleepModeNV glad_vkSetLatencySleepModeNV
